...
bool initializeFont() {
	...
	// -----------------------------------
	glGenVertexArrays(1, &textMesh.vertexArrayObject);
	glGenBuffers(1, &textMesh.vertexBufferObject);
	glBindVertexArray(textMesh.vertexArrayObject);
	glBindBuffer(GL_ARRAY_BUFFER, textMesh.vertexBufferObject);
