...
inline bool enumToString(enumType, std::string &)
{
	return false;
}

template<typename enumType>
inline bool stringToEnum(std::string_view enumString, enumType &)
{
	return false;
}

template <typename enumType>
inline std::string enumToString(enumType enumVal)
{
	std::string result;
...
template <typename enumType>
inline enumType stringToEnum(std::string_view enumString)
{
	enumType result;
